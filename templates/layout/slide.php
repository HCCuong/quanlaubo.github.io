<?php if (count($slider)) { ?>
    ...
    <div class="box-slider">
        <div class="wrap-content d-xl-flex justify-content-between">
            <div class="left-slider">
                <span class="image-slide scale-img effect-1">
                    <?= $func->getImage(['class' => 'lazy w-100', 'sizes' => '330x235x1', 'upload' => 'assets/images/', 'image' => 'slideimg.png', 'alt' => '']) ?>
                </span>
            </div>
                        ...
                        <?php foreach ($slider as $v) { ?>
                            <div class="slideshow-item" owl-item-animation>
                                <a class="slideshow-image" href="<?= $v['link'] ?>" target="_blank" title="<?= $v['name' . $lang] ?>">
                                    <?= $func->getImage(['class' => 'lazy w-100', 'sizes' => '804x462x1', 'upload' => UPLOAD_PHOTO_L, 'image' => $v['photo'], 'alt' => $v['name' . $lang]]) ?>
                                </a>
                            </div>
                        <?php } ?>
                    </div>
