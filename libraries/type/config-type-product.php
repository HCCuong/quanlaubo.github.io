...
$config['product'][$nametype]['check'] = array("noibat" => "Bán chạy", "noibat1" => "Nổi bật", "hienthi" => "Hiển thị");
$config['product'][$nametype]['images'] = true;
$config['product'][$nametype]['show_images'] = true;
$config['product'][$nametype]['gallery'] = array(
    $nametype => array(
        "title_main_photo" => "Hình ảnh món ăn",
...
$config['product'][$nametype]['width'] = 280 * 3;
$config['product'][$nametype]['height'] = 280 * 3;
...
/* Sản phẩm (List) */
$config['product'][$nametype]['title_main_list'] = "Thực đơn cấp 1";
...
/* Sản phẩm (Cat) */
$config['product'][$nametype]['title_main_cat'] = "Thục đơn cấp 2";
