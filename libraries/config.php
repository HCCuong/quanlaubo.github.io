...
/* Cấu hình coder */
define('NN_CONTRACT', 'source_tt');
define('NN_AUTHOR', 'hungchung.nina@gmail.com');

/* Cấu hình chung */
$config = array(
    'author' => array(
        'name' => 'Solchung',
        'email' => 'hungchung.nina@gmail.com',
    ...
    'googleAPI' => array(
        'recaptcha' => array(
            ...
            'sitekey' => '6Lfh1IMgAAAAABIZD10Ce4F2AOgu-IsXFf1HUvDA',
            'secretkey' => '6Lfh1IMgAAAAAH4UntNh5gPAD82hvUwIP1lwmIaW'
        )
    ),
    'oneSignal' => array(
        'active' => false,
